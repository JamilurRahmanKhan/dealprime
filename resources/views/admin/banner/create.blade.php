...
<div class="row">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add Banner form</h4>
                    ...
                    <form class="form-horizontal" action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <input type="file" class="form-control" id="imageInput" name="image"  accept="image/*" required="required">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" autocomplete="off" name="image_url" placeholder="Image url" class="form-control" required>
                            ...
                            <div class="col-md-9">
                                @for ($i = 1; $i <= 4; $i++)
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="banner_position" type="checkbox" id="{{ $i }}" value="{{ $i }}">
                        ...
                        <div class="justify-content-end row">
                            <div class="col-9">
                                <input type="submit" value="Add Banner" class="btn btn-info" />
    ...
    <script>
        ...
        // $(document).ready(function () {
        //     let isImageValid = false; // To track image validation status


        //     $('form').on('submit', function (e) {
        //         if (!isImageValid) {
        //             e.preventDefault(); // Prevent form submission
        //             $('#imageError').text('Please upload a valid image with a height of 200px.').show();
        //         }
        //     });
        // });
    </script>
