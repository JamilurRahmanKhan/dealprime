...
<div class="row">
        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Fetures Module</a></li>
                      <li class="breadcrumb-item active" aria-current="page">Feture Add</li>
                    </ol>
                  </nav>
                 </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add Features form</h4>
                    ...
                    <form class="form-horizontal" action="{{ route('features.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="name" id="name" value="{{old('name')}}" placeholder="Features Name"/>
