...
@section('title')Policy Create @endsection
@section('body')
<div class="row">
    <div class="col-12">
            ...
            <div class="page-title-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Policy Add</li>
                    </ol>
                  </nav>
                 </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add Policy form</h4>
                    <p class="text-muted font-14">{{ Session::get('failed') }}</p>
                    <form class="form-horizontal" action="{{ route('policy.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea name="title" class="form-control" placeholder="Policy title" id="policyTitle" cols="3" rows="3"></textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea name="sub_title" class="form-control" placeholder="Policy sub title" id="policySubTitle" cols="3" rows="3"></textarea>
                        ...
                        <div class="justify-content-end row">
                            <div class="col-9">
                                <button type="submit" class="btn btn-info">Add Policy</button>
                            </div>
                        </div>
                    </form>
                </div>  <!-- end card-body -->
...
$(document).ready(function() {
    ...
    $("form").submit(function(e) {
        ...
        // Title validation: Can not exceed 5 words
        ...
        // Subtitle validation: Can not exceed 10 words
        ...
        // Image validation: Must be 50x50 px
