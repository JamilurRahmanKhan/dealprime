            ...
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ route('role.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="roleName" placeholder="Role Name" value="{{ old('name') }}" />
                            @error('name')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-9">
                            <textarea class="form-control @error('description') is-invalid @enderror" id="roleDescription" name="description" placeholder="Role Description">{{ old('description') }}</textarea>
                            @error('description')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    </div>
                    <span  id="allSelect">All Select</span>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="checkbox" class="mt-2 permission-checkbox" name="permissions[]" value="{{ $permission->id }}" id="permission-{{ $permission->id }}" data-group="{{ $group }}">
