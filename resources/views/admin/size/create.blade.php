...
@section('title')Sizes Create @endsection
@section('body')
<div class="row">
    <div class="col-12">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add Sizes form</h4>
                    ...
                    <form class="form-horizontal" action="{{ route('sizes.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{old('name')}}" name="name" id="name" placeholder="Size Name"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{old('code')}}" name="code" id="code" placeholder="Size Code"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" cols="3" rows="3" placeholder="Size Description" id="description" value={{old('description')}}></textarea>
