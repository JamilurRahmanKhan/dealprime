...
<div class="row">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add Color form</h4>
                    ...
                    <form class="form-horizontal" action="{{ route('colors.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{old('name')}}" name="name" id="name" placeholder="Color Name"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="color" class="form-control" value="{{old('code')}}" name="code" id="code" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" cols="3" rows="3" placeholder="Color  Description" id="description" value={{old('description')}}></textarea>
                        ...
                        <div class="justify-content-end row">
                            <div class="col-9">
                                <button type="submit" class="btn btn-info">Add Color</button>
                            </div>
                        </div>
                    </form>
                </div>  <!-- end card-body -->
