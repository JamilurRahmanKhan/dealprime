...
@section('title')PopUp Create @endsection
@section('body')
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <div class="page-title-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="{{route('popups.index')}}">PopUp Module</a></li>
                      <li class="breadcrumb-item active" aria-current="page">PopUp Add</li>
                    </ol>
                  </nav>
                 </div>
            <h2 class="page-title">PopUp Module</h2>
        </div>
    </div>
</div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add PopUp form</h4>
                    <p class="text-muted font-14">{{ Session::get('failed') }}</p>
                    <form class="form-horizontal" action="{{ route('popups.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{old('image_link')}}" name="image_link" id="image_link" placeholder="Set URL"/>
                        ...
                        <div class="justify-content-end row">
                            <div class="col-9">
                                <button type="submit" class="btn btn-info">Add PopUp</button>
                            </div>
                        </div>
                    </form>
                </div>  <!-- end card-body -->
