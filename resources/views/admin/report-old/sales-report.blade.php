...
{{--                                @php--}}
{{--                                    $totalOrder = count($sales_reports);--}}
{{--                                @endphp--}}
                        ...
                        <form action="{{route('sales.report')}}" method="get" >
                            ...
                            <div class="row m-auto">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="date" value="{{Session::get('date_from')}}" name="date_from" class="form-control"   >
                                </div>
                                <div class="col-3">
                                    <label class="form-label">To Date</label>
                                    <input type="date" name="date_to"  value="{{Session::get('date_to')}}" class="form-control me-1 "  >
                                </div>
                                <div class="col-4">
