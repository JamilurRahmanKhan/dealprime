...
@section('title')Courier District Add @endsection
@section('body')
<div class="row">
    <div class="col-12">
            ...
            <div class="page-title-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Courier District Create</li>
                    </ol>
                  </nav>
                 </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add Courier District form</h4>
                    ...
                    <form class="form-horizontal" action="{{route('district.store')}}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{old('name')}}" name="name" id="name" placeholder="District Name"/>
