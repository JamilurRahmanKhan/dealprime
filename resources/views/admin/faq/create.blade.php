...
@section('title')Faqs Create @endsection
@section('body')
<div class="row">
    <div class="col-12">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add Faqs form</h4>
                    ...
                    <form class="form-horizontal" action="{{ route('faq.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{old('question')}}" name="question" id="question" placeholder="Question ?"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="answer" cols="3" rows="3" placeholder="Answer" id="answer" ></textarea>
