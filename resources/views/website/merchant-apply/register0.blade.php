            ...
            <div class="col-lg-5">
                <div class="card py-2">
                    <div class="card-body">
                        ...
                        <span > First please read our teams and condition for become a merchant.</span>
                        <form  action="{{route('merchant.store')}}" method="post" id="merchantForm" class="mb-0 mt-3">
                            @csrf
                            <div>
                                <label for="name" class="form-label">Merchant Holder Name <span class="text-danger">*</span></label>
                            ...
                            <div class="text-center ">
                                ...
                                <label for="terms" style="text-decoration: none"> <a href="">Terms & condition</a></label>
