...
{{--                                <a href="{{ route('customer.logout') }}" class="btn btn-link ">Log out</a>)--}}
                                              ...
                                              <!--{{$order}}-->
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else 
                                                            {{ number_format($order->order_total - $order->advance_payment ) }} tk
                                                        @endif
                                                    </td>
                                                    <td>
                            ...
                            <form class="mb-2" action="{{route('store.billing_address')}}" method="post">
                                ...
                                <div class="form-footer mb-0">
                                    <div class="form-footer-right">
                                        <button type="submit" id="saveAddressButton" class="btn btn-dark py-4">
                                            Save Address
                                        </button>
  ...
  <!--Delivery addresss validation -->
    ...
    <script>
        $(document).ready(function() {
            $("#changePassword button[type='submit']").on("click", function(event) {
            let isValid = true;
            ...
            if (!password) {
                $("#password").after('<small class="text-danger">Current Password is required.</small>');
                isValid = false;
            }
            ...
            if (!newPassword) {
                $("#new-password").after('<small class="text-danger">New Password is required.</small>');
                isValid = false;
            } else if (newPassword.length < 8) {
                $("#new-password").after('<small class="text-danger">Password must be at least 8 characters long.</small>');
                isValid = false;
            }
            ...
            if (!confirmPassword) {
                $("#confirm-password").after('<small class="text-danger">Confirm Password is required.</small>');
                isValid = false;
            } else if (newPassword !== confirmPassword) {
                $("#confirm-password").after('<small class="text-danger">Passwords do not match.</small>');
                isValid = false;
            }
