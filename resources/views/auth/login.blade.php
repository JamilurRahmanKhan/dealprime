    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xxl-4 col-lg-5">
                <h2 class="text-center bg-info text-white m-0 py-3 ">Sign In</h2>
                <div class="card">

                    <!-- Logo -->
                    {{-- <div class="card-header text-center bg-dark">
                        <a href="{{route('home')}}">
                            <span><img src="{{asset('/')}}admin/assets/images/gadget.jpg" alt="logo" class="w-75" height="80"/></span>
                            <h3 class="text-white my-2">Sign In</h3>
                        </a>
                    </div> --}}
                            ...
                            <div class="mb-3 mb-3">
                                <div class="form-check">
                                   ...
                                   <a href="{{route('register')}}">
                                     <label class="form-check-label float-end" >Sign Up</label></a>
                                </div>
                            </div>
